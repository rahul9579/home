...
@section('main-container')
  ...
  <main class='main'>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-5">
            ...
            <div class="contact_bt"><a href="contact">CONTACT US<span class="contact_padding"><img src="{{asset('frontend/images/contact-icon.png')}}"></span></a></div>
          </div>
          <div class="col-sm-2">
            <div class="play_icon"><a href="#"><img src="{{asset('frontend/images/play-icon.png')}}"></a></div>
          </div>
          <div class="col-sm-5">
    ...
    <div class="services_section layout_padding">
      <div class="container">
        <h1 class="services_taital"><span>Our</span> <img src="{{asset('frontend/images/icon-1.png')}}"> <span style="color: #1f1f1f">Services</span></h1>
    ...
    <div class="choose_section layout_padding">
      <div class="container">
        <h1 class="choose_taital"><span>Why </span> <img src="{{asset('frontend/images/icon-1.png')}}"> <span style="color: #1f1f1f">Choose Us</span></h1>
    ...
    <div class="team_section layout_padding">
      <div class="container">
        <h1 class="choose_taital"><span>Our </span> <img src="{{asset('frontend/images/icon-1.png')}}"> <span style="color: #1f1f1f">Team</span></h1>
        <p class="choose_text">Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                ...
                <div class="col-sm-5">
                  ...
                  <div class="follow_social_icon">
                    <ul>
                      ...
                      <li><a href="#"><img src="{{asset('frontend/images/linkden-icon.png')}}"></a></li>
